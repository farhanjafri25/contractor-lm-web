...
const KPI_INNER_STYLES: Record<KpiTone, string> = {
  emerald: 'card-surface bg-background text-foreground',
  blue: 'card-surface bg-background text-foreground',
  violet: 'card-surface bg-background text-foreground',
  cyan: 'card-surface bg-background text-foreground',
  danger: 'card-surface bg-background text-foreground',
};
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-10">
        <section className="grid gap-x-4 gap-y-6 sm:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-6">
          {kpiCards.map((card) => (
